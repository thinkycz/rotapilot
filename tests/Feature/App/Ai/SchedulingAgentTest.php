...
\test('scheduling agent instructions route live data and proposals to the correct tools', function (): void {
    ...
    static::assertStringContainsString('Before changing an existing assignment', $instructions);
    static::assertStringContainsString('shift.unassign` before the replacement `shift.assign', $instructions);
    static::assertStringContainsString('Use `ProposeSchedulingChangesTool` only when the manager asks to create, update, delete, assign, unassign, or auto-fill', $instructions);
