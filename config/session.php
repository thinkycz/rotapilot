...
return [
    ...
    */
    ...
    'driver' => $env->parseNullableString('SESSION_DRIVER') ?? $env->appEnvMap([
        'local' => 'file',
        'testing' => 'array',
        'development' => 'redis',
        'staging' => 'redis',
    ...
    */
    ...
    'connection' => $env->parseNullableString('SESSION_CONNECTION'),
    ...
    */
    ...
    'table' => $env->parseNullableString('SESSION_TABLE') ?? 'sessions',
    ...
    */
    ...
    'store' => $env->parseNullableString('SESSION_STORE'),
    ...
    */
    ...
    'path' => $env->parseNullableString('SESSION_PATH') ?? '/',
    ...
    */
    ...
    'domain' => $env->parseNullableString('SESSION_DOMAIN'),
    ...
    */
    ...
    'secure' => $env->parseNullableBool('SESSION_SECURE_COOKIE') ?? $env->appEnvIs(['staging', 'production']),
    ...
    */
    ...
    'same_site' => $env->parseNullableString('SESSION_SAME_SITE') ?? 'lax',
